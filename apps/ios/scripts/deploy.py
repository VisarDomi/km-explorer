...
job={{'Label':{label!r},'ProgramArguments':['/bin/bash','scripts/build.sh'],'WorkingDirectory':{MAC!r},'EnvironmentVariables':{{'DEVELOPMENT_TEAM':{TEAM!r},'SIGNING_DEVICE':{DEVICE!r}}},'RunAtLoad':True,'StandardOutPath':{log!r},'StandardErrorPath':{log!r}}}
